...
export default function WarningSigns() {
  ...
  return (
    <section
      className="section-padding overflow-hidden bg-brand-slate/92 backdrop-blur-sm"
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 text-center">
          <p className="text-sm text-gray-500">
            Not sure? Try this:{' '}
            <a href="#diy-test" className="font-semibold text-brand-teal hover:underline">
...
function SignCard({ sign, index }: { sign: (typeof signs)[number]; index: number }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm leading-relaxed text-gray-300">{sign.text}</p>
    </div>
  );
}
